            ...
            return (
              <div key={site.host} className="rounded-lg border border-border bg-surface p-4">
                ...
                <div className="mt-4 flex gap-2">
                  <button type="button" onClick={() => openEditSite(globalIndex)} className="flex-1 rounded-md border border-border px-3 py-2 text-sm hover:bg-hover">
                    <Pencil size={14} className="mr-1 inline" /> Edit
                  </button>
                  <button type="button" onClick={() => setDeleteIndex(globalIndex)} className="rounded-md border border-border px-3 py-2 text-sm text-red-r1 hover:bg-hover">
                    <Trash2 size={14} />
                  </button>
                </div>
              </div>
                  ...
                  <tr key={site.host} className="border-b border-border last:border-0 hover:bg-hover/50">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex justify-end gap-2">
                        <button type="button" onClick={() => openEditSite(globalIndex)} className="rounded-md border border-border px-3 py-1.5 text-xs hover:bg-hover">
                          Edit
                        </button>
                        <button type="button" onClick={() => setDeleteIndex(globalIndex)} className="rounded-md border border-border px-3 py-1.5 text-xs text-red-r1 hover:bg-hover">
                          Remove
                        </button>
                      </div>
                    </td>
